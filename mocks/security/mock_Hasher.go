...
func (_m *MockHasher) Compare(hashed string, plain string) bool {
...
//   - hashed string
//   - plain string
func (_e *MockHasher_Expecter) Compare(hashed interface{}, plain interface{}) *MockHasher_Compare_Call {
	return &MockHasher_Compare_Call{Call: _e.mock.On("Compare", hashed, plain)}
}

func (_c *MockHasher_Compare_Call) Run(run func(hashed string, plain string)) *MockHasher_Compare_Call {
...
func (_m *MockHasher) Hash(plain string) (string, error) {
	ret := _m.Called(plain)
...
//   - plain string
func (_e *MockHasher_Expecter) Hash(plain interface{}) *MockHasher_Hash_Call {
	return &MockHasher_Hash_Call{Call: _e.mock.On("Hash", plain)}
}

func (_c *MockHasher_Hash_Call) Run(run func(plain string)) *MockHasher_Hash_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
